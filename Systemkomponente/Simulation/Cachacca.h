...
//!	Generated Date	: Wed, 16, Sep 2015  
	File Path	: Systemkomponente/Simulation/Cachacca.h
*********************************************************************/
...
//## class Cachacca
class Cachacca : public Abfuellstation {
    ////    Friends    ////
    
public :

#ifdef _OMINSTRUMENT
    friend class OMAnimatedCachacca;
#endif // _OMINSTRUMENT

    ////    Constructors and destructors    ////
    
    //## auto_generated
    Cachacca(IOxfActive* theActiveContext = 0);
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedCachacca : public OMAnimatedAbfuellstation {
    DECLARE_REACTIVE_META(Cachacca, OMAnimatedCachacca)
...
inline bool Cachacca::Running_IN() const {
    return state_4_subState == Running;
}

inline bool Cachacca::Running_isCompleted() {
    return ( IS_IN(terminationstate_9) );
}

inline bool Cachacca::terminationstate_9_IN() const {
    return Running_subState == terminationstate_9;
}

inline bool Cachacca::dosieren_IN() const {
