...
//!	Generated Date	: Wed, 16, Sep 2015  
	File Path	: Systemkomponente/Simulation/Eis.cpp
*********************************************************************/
...
#include "Waage.h"
//#[ ignore
#define System_Eis_Eis_SERIALIZE OM_NO_OP
//#]

//## package System

//## class Eis
Eis::Eis(IOxfActive* theActiveContext) {
    NOTIFY_REACTIVE_CONSTRUCTOR(Eis, Eis(), 0, System_Eis_Eis_SERIALIZE);
    setActiveContext(theActiveContext, false);
    initStatechart();
}

Eis::~Eis() {
    NOTIFY_DESTRUCTOR(~Eis, false);
    cancelTimeouts();
}

bool Eis::startBehavior() {
    bool done = false;
    done = Abfuellstation::startBehavior();
    return done;
}

void Eis::initStatechart() {
...
void Eis::cancelTimeouts() {
    cancel(Running_timeout);
}

bool Eis::cancelTimeout(const IOxfTimeout* arg) {
    bool res = false;
...
IOxfReactive::TakeEventStatus Eis::rootState_processEvent() {
...
IOxfReactive::TakeEventStatus Eis::Betrieb_processEvent() {
    IOxfReactive::TakeEventStatus res = eventNotConsumed;
    // State state_4
...
IOxfReactive::TakeEventStatus Eis::state_5_processEvent() {
    IOxfReactive::TakeEventStatus res = eventNotConsumed;
...
IOxfReactive::TakeEventStatus Eis::Offen_handleEvent() {
    IOxfReactive::TakeEventStatus res = eventNotConsumed;
...
IOxfReactive::TakeEventStatus Eis::state_4_processEvent() {
    IOxfReactive::TakeEventStatus res = eventNotConsumed;
...
IOxfReactive::TakeEventStatus Eis::Running_handleEvent() {
    IOxfReactive::TakeEventStatus res = eventNotConsumed;
...
IOxfReactive::TakeEventStatus Eis::terminationstate_9_handleEvent() {
    IOxfReactive::TakeEventStatus res = eventNotConsumed;
    res = Running_handleEvent();
    return res;
}

IOxfReactive::TakeEventStatus Eis::dosieren_handleEvent() {
    IOxfReactive::TakeEventStatus res = eventNotConsumed;
    if(IS_EVENT_TYPE_OF(OMTimeoutEventId))
        {
...
#ifdef _OMINSTRUMENT
//#[ ignore
void OMAnimatedEis::serializeAttributes(AOMSAttributes* aomsAttributes) const {
    OMAnimatedAbfuellstation::serializeAttributes(aomsAttributes);
}

void OMAnimatedEis::serializeRelations(AOMSRelations* aomsRelations) const {
    OMAnimatedAbfuellstation::serializeRelations(aomsRelations);
}

void OMAnimatedEis::rootState_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT");
    if(myReal->rootState_subState == Eis::Betrieb)
        {
            Betrieb_serializeStates(aomsState);
        }
}

void OMAnimatedEis::Betrieb_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.Betrieb");
    state_4_serializeStates(aomsState);
    state_5_serializeStates(aomsState);
}

void OMAnimatedEis::state_5_serializeStates(AOMSState* aomsState) const {
...
void OMAnimatedEis::Zu_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.Betrieb.state_5.Zu");
}

void OMAnimatedEis::Offen_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.Betrieb.state_5.Offen");
}

void OMAnimatedEis::state_4_serializeStates(AOMSState* aomsState) const {
...
void OMAnimatedEis::Stopped_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.Betrieb.state_4.Stopped");
}

void OMAnimatedEis::Running_serializeStates(AOMSState* aomsState) const {
...
void OMAnimatedEis::terminationstate_9_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.Betrieb.state_4.Running.ROOT.Running.terminationstate_9");
}

void OMAnimatedEis::dosieren_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.Betrieb.state_4.Running.ROOT.Running.dosieren");
}

void OMAnimatedEis::Idle_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.Betrieb.state_4.Idle");
}
//#]

IMPLEMENT_REACTIVE_META_S_P(Eis, System, false, Abfuellstation, OMAnimatedAbfuellstation, OMAnimatedEis)
