...
//!	Generated Date	: Wed, 16, Sep 2015  
	File Path	: Systemkomponente/Simulation/Eis.h
*********************************************************************/
...
//## class Eis
class Eis : public Abfuellstation {
    ////    Friends    ////
    
public :

#ifdef _OMINSTRUMENT
    friend class OMAnimatedEis;
#endif // _OMINSTRUMENT

    ////    Constructors and destructors    ////
    
    //## auto_generated
    Eis(IOxfActive* theActiveContext = 0);
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedEis : public OMAnimatedAbfuellstation {
    DECLARE_REACTIVE_META(Eis, OMAnimatedEis)
...
inline bool Eis::Running_IN() const {
    return state_4_subState == Running;
}

inline bool Eis::Running_isCompleted() {
    return ( IS_IN(terminationstate_9) );
}

inline bool Eis::terminationstate_9_IN() const {
    return Running_subState == terminationstate_9;
}

inline bool Eis::dosieren_IN() const {
